...
> Operational context only. AWS account IDs, credentials, IP allow-list entries, and specific security findings are intentionally kept out of this template — see access-controlled Jira/Confluence.
