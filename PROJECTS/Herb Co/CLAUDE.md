...
- **WAF:** SiteLock
- **Repos:** Adrian-controlled; Webapper has read-only mirror at `C:\Users\End-Dream-Office\dev\ibizfusion`. Migration to Webapper-controlled GitHub planned for Phase 2.
...
- **Claude Code:** would be `~/.claude/projects/herb-co/memory/` if running CC against the iBiz mirror at `C:\Users\End-Dream-Office\dev\ibizfusion`
...
- **Source mirror:** `C:\Users\End-Dream-Office\dev\ibizfusion` (read-only). For active dev work on the same code, see `C:\Users\End-Dream-Office\dev\dev-main`.
